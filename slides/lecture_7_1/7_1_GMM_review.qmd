...
As in the MLE case, the Wald statistic is based on how close $c(\hat\theta_u)$ is to zero
...
We will repeat the exercise of estimating a simple linear model using GMM. Again, the model is
