...
- Type or click on the link below. It's an invitation for a tutorial repository

[https://classroom.github.com/a/IECLK9zM](https://classroom.github.com/a/IECLK9zM)
...
I will send you an invitation to create a *Code portfolio* on GitHub. After accept it, the structure will be this

<div style="float: right">
  <img src="figures/portfolio_structure.png" height=430>
</div>

Naming conventions for:
- In-class activities: `2023MMDD.jl`
  - After class, save what you typed and commit
- Weekly problems: `weekly_problem_N.jl`
  - Commit the last version of the file before the submission deadline
- Mini-project
  - Include here all files relative to your project
  
Note that folder `etc` is grayed out. That's because it's in `.gitignore`
...
This is what the **Feedback** pull request page will look like after your first commit
...
--
  ...
  - We won't cover it, but you might also be interested in learning more about *Jupyter* and programming using code notebooks
  ...
  - You can learn more about *Jupyter* [here](https://julia.quantecon.org/getting_started_julia/getting_started.html)
    - And check out the video "IDE showcase: VS Code and Jupyter" I posted Brightspace materials for this unit
