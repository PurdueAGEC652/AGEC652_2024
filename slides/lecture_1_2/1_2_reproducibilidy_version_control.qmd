...
- After you accept an invitation from GitHub Classroom, it will create a new private repository
  - Only your team members and Diego will be able to see the repository's content
...
I will send you an invitation to create a *Code portfolio* on GitHub

::: {.columns}
::: {.column}
- Please create separate folders for each problem set and mini-project
- Use clear naming conventions
:::
::: {.column}
![](figures/portfolio_structure.png)
:::
:::
