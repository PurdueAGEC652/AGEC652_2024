...
We will assume household size is uncorrelated with being a homeowner or any city characteristics. Household size will follow a Poisson distribution with $\lambda = 3.0$ (the mean of this distribution)
...
Resulting in about 9.7% of the people saying they'd use the train.
...
So about 8.9%. This means few people would switch from bus to train, and most of the said new train riders are those switching from cars.
...
So, about 10% of the residents use the bus and 12% use the train.
