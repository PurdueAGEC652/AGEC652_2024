...
We don't know exactly how people who don't have the would respond to a question about whether they would use the train. Just for illustration, let's assume that individuals reason that the train would cost 10% more than the bus and be as good as increasing the number of bus stops by 40%.
...
Resulting in about 22% of the people saying they'd use the train.
...
So about 7.8%. This means few people would switch from bus to train, and most of the hypothetical new train riders are those switching from cars.
...
So, about 10% of the residents use the bus and 14% use the train.
